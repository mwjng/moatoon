...
//사전적으로 가져와야하는 데이터
//1. store에 저장된 보호자 회원에 속한 아동의 list : {(1, '아이닉네임'), (2, '화가가될거야야')}
//2. 키워드 테이블에서 MOOD, GENRE, THEME별 keyword_id, keyword를 모두 가져와야함. 
// {"Mood" : {(1, '평화로운 '), (2, '평화로운 '), (3, '평화로운 '),},
//"Genre" : {(5, '판타지 '), (6, '평화로운 '), (7, '평화로운 '),},
//"Theme" : {(8, '평화로운 '), (9, '평화로운 '), (10, '평화로운 '),}
//}
