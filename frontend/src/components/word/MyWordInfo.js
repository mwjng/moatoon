    ...
    return (
        <div className="group [perspective:1000px]">
            ...
            >
                {/* front side */}
                <div
                    className="p-4 mt-2 rounded-[30px] shadow-lg flex items-center justify-center h-[400px] w-[450px]
                ...
                {/* back side */}
                <div
                    className="px-4 py-4 mt-2 rounded-[30px] shadow-lg flex flex-col items-center justify-center h-[400px] w-[450px]
                ...
                >
                    ...
                    <div className="flex justify-between w-full h-full">
                        <div className="flex justify-center min-w-[140px] items-center text-[32px] font-bold [text-shadow:_0_2px_10px_rgb(0_0_0_/_40%)]">
                            {word.word}
                        </div>
