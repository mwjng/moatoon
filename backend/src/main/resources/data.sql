...
INSERT INTO PARTY (introduction, pin_number, book_cover, book_title, level, episode_count, progress_count, status, start_date, is_public, end_date, created_at, modified_at) VALUES
  ...
  ('현재 진행 중! 공주의 용감한 모험', '2001', 'cover.jpg', '용감한 공주', 1, 2, 1, 'ING', '2025-02-06 08:00:00', 1, '2025-02-13 08:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('요정의 숲을 지키는 전설', '2002', 'cover.jpg', '요정의 숲', 1, 2, 1, 'ING', '2025-02-06 08:00:00', 1, '2025-02-13 08:00:00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
